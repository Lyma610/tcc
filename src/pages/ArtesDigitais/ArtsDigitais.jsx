    ...
    <div className='layout'>
      ...
      <main className='main-content'>
        ...
        {filteredPosts.length > 0 ? (
          <TrendingSection
            title={selectedGenre === 'all' ? 'Todas as Artes Digitais' : `${genres.find(g => g.id === parseInt(selectedGenre))?.nome} - Artes Digitais`}
          ...
          <div style={{ padding: '40px', textAlign: 'center', color: '#fff' }}>
            <h3>Nenhuma arte digital encontrada para o gênero selecionado.</h3>
          </div>
        )}
      </main>
    </div>
