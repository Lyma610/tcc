    ...
    <div className="layout">
      ...
      <main className='main-content'>
        ...
        <div className="modern-filters" style={{ 
          marginBottom: '32px', 
          padding: '0 24px',
          background: 'linear-gradient(135deg, rgba(255, 60, 60, 0.1) 0%, rgba(185, 43, 39, 0.1) 100%)',
          borderRadius: '20px',
          padding: '24px',
            ...
            <button
              ...
              style={{
                ...
                background: selectedGenre === 'all' 
                  ? 'linear-gradient(135deg, #ff3c3c 0%, #b92b27 100%)' 
                  : 'rgba(255, 255, 255, 0.1)',
                color: selectedGenre === 'all' ? '#fff' : '#fff',
                borderRadius: '25px',
                cursor: 'pointer',
              ...
              <button
                ...
                style={{
                  ...
                  background: selectedGenre === genre.id.toString() 
                    ? 'linear-gradient(135deg, #ff3c3c 0%, #b92b27 100%)' 
                    : 'rgba(255, 255, 255, 0.1)',
                  color: selectedGenre === genre.id.toString() ? '#fff' : '#fff',
                  borderRadius: '25px',
                  cursor: 'pointer',
                  transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                  fontSize: '0.95rem',
        ...
        {filteredPosts.length > 0 ? (
          <TrendingSection
            title={selectedGenre === 'all' ? 'Todos os Filmes' : `${genres.find(g => g.id === parseInt(selectedGenre))?.nome} - Filmes`}
          ...
          <div style={{ padding: '40px', textAlign: 'center', color: '#fff' }}>
            <h3>Nenhum filme encontrado para o gênero selecionado.</h3>
          </div>
        )}
      </main>
    </div>
